...
{
	public static var osEngineVersion:String = '0.1.0'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(FlxG.width * 0.7, FlxG.height - 44, 0, "Flame Engine v" + osEngineVersion + " - Another Modded Psych Engine", 12);
